...
public class PowerExpressionTest extends ExpressionTestBase {
    ...
    public void testEval() throws ParseException {
        ...
        Object[][] tests = {
                {"1 " + op + " 2.9", Math.pow(1, 2.9)},
                {"2 " + op + " 0.2", Math.pow(2, 0.2)},
                {"1 " + op + " -2", Math.pow(1, -2)},
                {"1 " + op + " -1", Math.pow(1, -1)},
                {"10 " + op + " 2", Math.pow(10, 2)},
                {"100000 " + op + " -2", Math.pow(100000, -2)}
        };
